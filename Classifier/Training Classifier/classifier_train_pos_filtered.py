...
test_config = 'ag-news_pwws_distilbert_logits_pos_filtered.csv'

test_downstream_coinfig = [
    "ag-news_alzantot_distilbert_logits_pos_filtered.csv", 
    "ag-news_textfooler_distilbert_logits_pos_filtered.csv", 
    "imdb_bae_distilbert_logits_pos_filtered.csv", 
    "rotten-tomatoes_alzantot_distilbert_logits_pos_filtered.csv", 
]
